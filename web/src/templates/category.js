...
const CategoryTemplate = props => {
  ...
  const posts =
    ...
    data.projects.edges.map(post => {
      return (
        <StyledListItem>
          <StyledHeaderLink href={`/project/${post.node.slug.current}`}>
            <StyledPostHeader>{post.node.title}</StyledPostHeader>
          </StyledHeaderLink>
          <StyledListItemContainer first={true}>
            ...
            {post.node._rawMainImageCaption && (
              <StyledTextContainer first={true}>
                <BlockText
                  className="category__list-item-block category__list-item-block-first"
                  blocks={post.node._rawMainImageCaption}
                />
              </StyledTextContainer>
            )}
          </StyledListItemContainer>
          <StyledListItemContainer second={true}>
            ...
            {post.node._rawImageTwoCaption && (
              <StyledTextContainer second={true}>
                <BlockText
                  className="category__list-item-block category__list-item-block-first"
                  blocks={post.node._rawImageTwoCaption}
                />
              </StyledTextContainer>
            )}
          </StyledListItemContainer>
          <StyledListItemContainer>
            ...
            {post.node._rawImageThreeCaption && (
              <StyledTextContainer>
                <BlockText
                  className="category__list-item-block category__list-item-block-second"
                  blocks={post.node._rawImageThreeCaption}
                />
              </StyledTextContainer>
            )}
          </StyledListItemContainer>
      ...
      <StyledContainer>
        {category && (
          <div>
            ...
            <StyledUnorderedList>{posts}</StyledUnorderedList>
          </div>
        )}
      </StyledContainer>
    </Layout>
